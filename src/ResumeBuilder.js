...
const ResumeBuilder = () => {
  ...
  const handleDescriptionToggle = (index, isHovered) => {
    if (!sections[index].editing) {
      const updatedSections = [...sections];
      updatedSections[index].showDescription = isHovered;
      setSections(updatedSections);
          ...
          >
            <div className="section">
              ...
              <button
                ...
                onMouseEnter={() => handleDescriptionToggle(index, true)}
                onMouseLeave={() => handleDescriptionToggle(index, false)}
              ></button>
              {section.editing ? (
                <>
                  <input
                ...
                <>
                  ...
                  {hoveredIndex === index && section.showDescription && (
                    <div className="description-box">{section.description}</div>
                  )}
                </>
              )}
